@php
    $nama_web = get_setting_value('_site_name');
    ...
    $lokasi = get_setting_value('_location');
    $lahir = get_setting_value('_birthday');
    $pengalaman = get_setting_value('_experience');
    $deskripsi_web = get_setting_value('_site_description');
    ...
    >
      <a href="index.html" class="navbar-brand ml-lg-3">
        <h1 class="m-0 display-5">
          <span class="text-primary">{{$jumbotron->title}}</span>Portfolio
        </h1>
      </a>
      <button
        type="button"
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 text-center text-lg-left">
            ...
            <div class="typed-text d-none">
              Pelajar, Laravel Programmer, Web Developer, Rubik, Ngetik, GYM, Overthinking
            </div>
            <div
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 pb-4 pb-lg-0">
            <img class="img-fluid rounded w-100" src="{{Storage::url($about->thumbnail)}}" alt="" />
          </div>
          <div class="col-lg-7">
            ...
            <div class="row mb-3">
              <div class="col-sm-6 py-2">
                <h6>Name: <span class="text-secondary">{{$nama_web}}</span></h6>
              </div>
              <div class="col-sm-6 py-2">
                <h6>
                  Birthday: <span class="text-secondary">{{$lahir}}</span>
                </h6>
              </div>
              {{-- <div class="col-sm-6 py-2">
              ...
              <div class="col-sm-6 py-2">
                <h6>
                  Experience: <span class="text-secondary">{{$pengalaman}}</span>
                </h6>
              </div>
              {{-- <div class="col-sm-6 py-2">
                <h6>
      ...
      <div class="container">
        ...
        <div class="row pb-3">
          ...
          <div class="col-lg-4 col-md-6 text-center mb-5">
            <div class="d-flex align-items-center justify-content-center mb-4">
              <i
                class="fab fa-2x fa-android service-icon bg-primary text-white mr-3"
              ></i>
          ...
          <div class="col-lg-4 col-md-6 text-center mb-5">
            <div class="d-flex align-items-center justify-content-center mb-4">
              <i
                class="fa fa-2x fa-search service-icon bg-primary text-white mr-3"
              ></i>
          ...
          <div class="col-lg-4 col-md-6 text-center mb-5">
            <div class="d-flex align-items-center justify-content-center mb-4">
              <i
                class="fa fa-2x fa-edit service-icon bg-primary text-white mr-3"
              ></i>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
            <div class="position-relative overflow-hidden mb-2">
              ...
              >
                <a href="{{Storage::url($item->thumbnail)}}" data-lightbox="portfolio">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 mb-5">
            ...
            <h5 class="font-weight-medium mb-4">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="contact-form text-center">
              <div id="success"></div>
              <form action="https://formspree.io/f/mdorlkvv" method="POST" name="sentMessage" >
                <div class="form-row">
    ...
    >
      <div class="container text-center py-5">
        <div class="d-flex justify-content-center mb-4">
          <a target="_blank" class="btn btn-light btn-social mr-2" href="{{$twitter}}"
            ><i class="fab fa-twitter"></i
          ></a>
          <a target="_blank" class="btn btn-light btn-social mr-2" href="{{$facebook}}"
            ><i class="fab fa-facebook-f"></i
          ></a>
          <a target="_blank"class="btn btn-light btn-social mr-2" href="{{$linkedin}}"
            ><i class="fab fa-linkedin-in"></i
          ></a>
          <a target="_blank"class="btn btn-light btn-social" href="{{$instagram}}"
        ...
        <p class="m-0">
          &copy;
          <a class="text-white font-weight-bold" href="{{$instagram}}">{{$nama_web}}</a>. All
          Rights Reserved. Dibuat dengan <i class="fa-solid fa-heart" style="color: #ff0000;"></i>
          {{-- <a target="_blank" class="text-white font-weight-bold" href="{{$instagram}}"
            >{{$nama_web}}</a
          > --}}
        </p>
      </div>
